...
const Cart = () => {
    ...
    try {
      const res = await axios.post("https://pizzawebsite-main.vercel.app/api/orders", data);
      if (res.status === 201) {
        dispatch(reset());
            ...
            <div className={styles.right}>
                <div className={styles.wrapper}>
                    ...
                    <div className={styles.totalText}>
                        <strong className={styles.totalTextTitle}>Subtotal: </strong>{cart.total}€
                    </div>
                    <div className={styles.totalText}>
                        <strong className={styles.totalTextTitle}>Discount: </strong>0.00€
                    </div>
                    <div className={styles.totalText}>
                        <strong className={styles.totalTextTitle}>Total: </strong>{cart.total}€
                    </div>
                    {open ? (
                    <div className={styles.paymentMethods}>
                        ...
                        <PayPalScriptProvider
                            options={{
                                "client-id": "AWQRSu7et_jCcqpyYzzLyRIVaaG_7rt0HFjBUITSU6N_dprfB1h6Hv5sJ597R-QDJugyZZC2l_6Yo1Jm",
                                components: "buttons",
                                currency: "EUR",
